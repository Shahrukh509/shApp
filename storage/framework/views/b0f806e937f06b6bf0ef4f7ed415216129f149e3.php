                        ...
                        <div class="card border-primary rounded-0">
                            ...
                            <div class="card-header p-0">
                                <div class=" text-white text-center py-2">
                                    <h3><i class="fa fa-envelope"></i><?php echo e($data[0]->Heading); ?></h3>
                                    <p class="m-0"><?php echo e($data[0]->Description); ?></p>
                                </div>
                            </div>
...
<?php echo $__env->make('frontend.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\SHapp\resources\views/frontend/contact_us.blade.php ENDPATH**/ ?>